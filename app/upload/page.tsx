...
export default async function Home() {
  // Mengambil data publikasi terbaru dari database Supabase
  ...
  return (
    <div className="min-h-screen p-8 md:p-16">
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {/* Header Section - Bersih dan Minimalis */}
        ...
        {/* Latest Releases Section - Langsung ke konten utama */}
        <section>
        ...
        {/* Catatan: Tombol floating "+ Unggah Paper" telah dihapus dari sini. 
          Akses pengunggahan dialihkan melalui link "Admin Area" di Sidebar agar tidak terlihat oleh Client.
        */}
